...
const PurchaseHistory : React.FC<Props> = ({navigation}) => {
    ...
    function handleModalClose(values:{city:string,startDate:string,endDate:string,attribute:string,sortDirection:string,}){
        setShowModal(false);
        alert(JSON.stringify(values));
        //------------------------------

        // -- backend connection here --
        //(~values~ contains all query params)
    ...
    return (
        <View style={styles.container}>
            <PurchaseFilterModal show={showModal} onClose={handleModalClose}/>
